...
export default function Header() {
  return (
    ...
    >
      ...
      <div className="flex items-center justify-around  w-full h-full py-4">
        <div className="md:flex items-center hidden">
          <Link
            href="/"
          >
            <Image src="/logo.png" height={100} width={140} quality={100} priority alt='logo - Flaga' />
          </Link>
        </div>

        <div className='hidden md:flex w-full max-w-[600px]'><SearchForm /></div>
      ...
      <div className='flex md:hidden mb-4 w-full px-5'><SearchForm /></div>
